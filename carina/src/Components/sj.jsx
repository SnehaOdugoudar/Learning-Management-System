    ...
    return (
        <div className="container" >
          <ul className="nav nav-tabs bg-secondary">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="tab-content">
                                                                ...
                                                                <div className={`tab-pane ${activeTab === 'announcement' ? 'active show' : ''}`}>
                                                                    <h3>Announcements</h3>
                                                                    <p>Course announcements will be posted here.</p>
                                                                ...
                                                                <div className={`tab-pane ${activeTab === 'grade' ? 'active show' : ''}`}>
                                                                    <h3>Grade</h3>
                                                                    <p>Your current grade in the course: {course.grade}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
            ...
            <footer className="footer bg-secondary p-3" style={{ width: "100%", position: "fixed", bottom: "0", paddingLeft: 0, paddingRight: 0, textAlign: "center" }}>
                <p>@GoTeam2024</p>
            </footer>
        </div>
    );
